...
#mpirun -np 4 xterm -e "valgrind --max-stackframe=8000000 --suppressions=/usr/share/openmpi/openmpi-valgrind.supp  ./examples/fexample-int &>log\$OMPI_COMM_WORLD_RANK"
